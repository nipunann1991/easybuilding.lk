                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tbody><tr>
                        <th class="column-top" width="145" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody><tr>
                              <td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left; text-align: center;">
                                <a href="<?php echo $live_url; ?> " target="_blank"><img src="https://easybuilding.biz/assets/images/top-header.png" width="350" height="68" border="0" alt=""></a></td>
                            </tr>
                          </tbody></table>
                        </th> 
                      </tr>
