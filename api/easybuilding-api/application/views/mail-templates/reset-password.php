                      ...
                      <tbody><tr>
                        <td class="p30-15" style="padding: 30px 30px 0px 30px;">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                              <tr>
                                <td class="h1 pb25" style="color:#444444; font-family:'Merriweather', Georgia,serif; font-size:25px; line-height:42px; text-align:center; padding-bottom:25px;">Reset Password in Easybuilding.lk!</td>
                              </tr>
                              <tr>
                                <td class="text-center pb25" style="color:#666666; font-family:Arial,sans-serif; font-size:14px; line-height:23px; text-align:center; padding-bottom:25px;">
                                 ...
                                 Hello <?php echo $name; ?>,</span> Thank you very much for logging into Easybuilding.lk.Click on below link which will help you to change your password. </td>
                              </tr>
                              <tr>
                                <td class="text-center pb25" style="color:#666666; font-family:Arial,sans-serif; font-size:21px; line-height:28px; text-align:center; padding-bottom:25px;">  
                                  Verification Code: <b><?php echo $verifycode; ?></b></td>
                              </tr>
                              <tr>
                                <td class="text-center pb25" style="color:#666666; font-family:Arial,sans-serif; font-size:14px; line-height:23px; text-align:center; padding-bottom:25px;">Simply click the button below to reset your password.</td>
                              </tr> 
                            <!-- Button -->
                            <tr>
                              <td align="center">
                                <table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                                  <tbody><tr>
                                    <td class="text-button" style="background: #27B9FD;color: #ffffff; font-family:Arial,sans-serif; font-size:16px; line-height:18px; padding:12px 15px; text-align:center; border-radius:3px; ">
                                      <a href="<?php echo $profileURL .'reset-password/?email='. $email.'&verifycode='.$verifycode.'&client_id='.$client_id; ?>" target="_blank" class="link" style="color: #ffffff;text-decoration:none;"><span class="link" style="color: #ffffff; text-decoration:none;     font-weight: bold;">Reset my password</span></a> 
