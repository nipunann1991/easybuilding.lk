...
const routes: Routes = [{ path: '', component: PageContainerComponent, children: [
    ...
    { path: 'services', loadChildren: () => import('../../../web/pages/products/products.module').then(m => m.ProductsModule) }, 
    { path: 'services/:id', loadChildren: () => import('../../../web/pages/products/products.module').then(m => m.ProductsModule) }, 
    { path: 'photos', loadChildren: () => import('../../../web/pages/products/products.module').then(m => m.ProductsModule) }, 
    { path: 'photos/:id', loadChildren: () => import('../../../web/pages/image-search/image-search.module').then(m => m.ImageSearchModule) },
    { path: 'my-account',  loadChildren: () => import('../../../web/pages/my-account/my-account.module').then(m => m.MyAccountModule) },
    { path: 'steps', canActivate: [AuthGuard], loadChildren: () => import('../my-account/pages/steps/steps.module').then(m => m.StepsModule) },
